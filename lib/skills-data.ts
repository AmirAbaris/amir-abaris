...
export const primarySkills: Skill[] = [
  ...
  { id: "typescript", name: "TypeScript", icon: "/icons/skills/typescript.svg" },
  { id: "javascript", name: "JavaScript", icon: "/icons/skills/javascript.svg" },
];
...
export const skillGroups: SkillGroup[] = [
  {
    label: "UI & Mobile",
    skills: [
      { id: "react-native", name: "React Native", icon: "/icons/skills/reactnative.svg", colored: true },
      { id: "expo", name: "Expo", icon: "/icons/skills/expo.svg" },
      { id: "tailwind", name: "TailwindCSS", icon: "/icons/skills/tailwindcss.svg" },
      { id: "nativewind", name: "NativeWind", icon: "/icons/skills/nativewind.svg" },
  ...
  },
  {
    label: "State & Data",
    skills: [
      { id: "zustand", name: "Zustand", icon: "/icons/skills/zustand.svg", colored: true },
      { id: "tanstack-query", name: "TanStack Query", icon: "/icons/skills/reactquery.svg" },
    ],
  },
  {
